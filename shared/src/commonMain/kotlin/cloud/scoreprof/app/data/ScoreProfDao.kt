...
interface ScoreProfDao {
    ...
    suspend fun getLeagueCode(leagueid: String, owneruserid: String): String
    ...
    suspend fun getLatestSetup(userid: String): Setup?
    ...
    @Upsert
    suspend fun upsertLeagueTable(leagueTable: List<LeagueTable>)
    ...
    suspend fun softDeleteLeague(leagueid: String, owneruserid: String, state: String = "Deleted", isSelected: Boolean = false)
...
""")
    ...
    suspend fun getCompetitionIdForLeague(leagueid: String, owneruserid: String): String
    ...
    @Transaction
    suspend fun deleteLeague(leagueid: String, owneruserid: String) {
    ...
    @Query("DELETE FROM leagues WHERE leagueid = :leagueid AND owneruserid = :owneruserid")
    suspend fun deleteFromLeagues(leagueid: String, owneruserid: String)

    @Query("DELETE FROM league WHERE leagueid = :leagueid AND owneruserid = :owneruserid")
    suspend fun deleteFromLeague(leagueid: String, owneruserid: String)

    @Query("DELETE FROM league_header WHERE leagueid = :leagueid AND owneruserid = :owneruserid")
    suspend fun deleteFromLeagueHeader(leagueid: String, owneruserid: String)

    @Query("DELETE FROM league_invitations WHERE leagueid = :leagueid AND owneruserid = :owneruserid")
    suspend fun deleteFromLeagueInvitation(leagueid: String, owneruserid: String)

    @Query("DELETE FROM league_table WHERE leagueid = :leagueid AND owneruserid = :owneruserid")
    suspend fun deleteFromLeagueTable(leagueid: String, owneruserid: String)

    @Query("DELETE FROM UserLeagueSelection WHERE leagueid = :leagueid AND owneruserid = :owneruserid")
    suspend fun deleteFromUserLeagueSelection(leagueid: String, owneruserid: String)

    @Query("DELETE FROM user_league_users WHERE leagueid = :leagueid AND owneruserid = :owneruserid")
    suspend fun deleteFromUserLeagueUsers(leagueid: String, owneruserid: String)

    @Query("UPDATE userleagueselection SET selected = :selected WHERE leagueid = :leagueid AND owneruserid = :owneruserid")
    suspend fun updateUserLeagueSelection(leagueid: String, owneruserid: String, selected: Boolean)

    @Query("SELECT * FROM league_table WHERE leagueid = :leagueid AND owneruserid = :owneruserid ORDER BY points DESC")
    suspend fun getLeagueTableList(leagueid: String, owneruserid: String): List<LeagueTable>

    @Insert(onConflict = OnConflictStrategy.REPLACE)
    suspend fun insertLeagueTable(table: List<LeagueTable>)

    @Transaction
    suspend fun updateLeagueTableCache(leagueid: String, owneruserid: String, table: List<LeagueTable>) {
        deleteFromLeagueTable(leagueid, owneruserid)
