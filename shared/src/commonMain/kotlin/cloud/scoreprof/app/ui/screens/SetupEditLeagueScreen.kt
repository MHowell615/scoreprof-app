...
import cloud.scoreprof.app.league_code
import cloud.scoreprof.app.league_name
import cloud.scoreprof.app.edit_league
import cloud.scoreprof.app.league_share
        ...
        topBar = {
            Surface(
                ...
                Row(
                    ...
                    Text(
                        text = stringResource(Res.string.edit_league),
        ...
        LazyColumn(
            ...
            item {
                Row(verticalAlignment = Alignment.CenterVertically, modifier = Modifier.padding(vertical = 2.dp)) {
                    Text(text = stringResource(Res.string.league_code), style = TextStyle(fontSize = 18.sp, fontWeight = FontWeight.Bold, color = MaterialTheme.colorScheme.primary))
                ...
                Text(text = stringResource(Res.string.league_share), style = TextStyle(fontSize = 14.sp, color = MaterialTheme.colorScheme.primary), modifier = Modifier.padding(vertical = 4.dp))
            }
