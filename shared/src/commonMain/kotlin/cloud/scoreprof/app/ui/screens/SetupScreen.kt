...
import cloud.scoreprof.app.privacy
import cloud.scoreprof.app.setup
import cloud.scoreprof.app.setup_text_1
import cloud.scoreprof.app.setup_text_2
import cloud.scoreprof.app.email
import cloud.scoreprof.app.password
import cloud.scoreprof.app.username
        ...
        LazyColumn(
            ...
            item {
                Text(
                    ...
                    text = stringResource(Res.string.setup_text_1),
            ...
            item {
                Text(
                    modifier = Modifier.fillMaxWidth(),
                    textAlign = TextAlign.Center,
                    text = stringResource(Res.string.setup_text_2),
                    style = TextStyle(fontSize = 14.sp, color = MaterialTheme.colorScheme.primary)
                )
                Spacer(modifier = Modifier.height(16.dp))
            }
            ...
            item {
                Button(
                    ...
                    Text(
                        stringResource(Res.string.competitions),
                        style = TextStyle(
                            fontSize = 20.sp,
            ...
            item {
                Button(
                    ...
                    Spacer(modifier = Modifier.height(8.dp))
                    Text(
                        stringResource(Res.string.leagues),
                        style = TextStyle(
                            fontSize = 20.sp,
                            fontWeight = FontWeight.Bold,
                            color = MaterialTheme.colorScheme.primary
